...
public bool VGFSearchAnFile(string FileName)
{
...
///-------------------------------------------------
[Flags]
 public enum VGFFileSystemOSFeature : uint {
     /// <summary>
     /// The file system supports case-sensitive file names.
     /// </summary>
     VGFCaseSensitiveSearch = 1,
     /// <summary>
     /// The file system preserves the case of file names when it places a name on disk.
     /// </summary>
     VGFCasePreservedNames = 2,
     /// <summary>
     ...
     /// </summary>
     VGFFileCompression = 0x10,
     /// <summary>
     /// The file system supports disk quotas.
     /// </summary>
     VGFVolumeQuotas = 0x20,
     /// <summary>
     /// The file system supports sparse files.
     /// </summary>
     VGFSupportsSparseFiles = 0x40,
     /// <summary>
     /// The file system supports re-parse points.
     /// </summary>
     VGFSupportsReparsePoints = 0x80,
     /// <summary>
     /// The specified volume is a compressed volume, for example, a DoubleSpace volume.
     /// </summary>
     VGFVolumeIsCompressed = 0x8000,
     /// <summary>
     /// The file system supports object identifiers.
     /// </summary>
     VGFSupportsObjectIDs = 0x10000,
     /// <summary>
     /// The file system supports the Encrypted File System (EFS).
     /// </summary>
     VGFSupportsEncryption = 0x20000,
     /// <summary>
     /// The file system supports named streams.
     /// </summary>
     VGFNamedStreams = 0x40000,
     /// <summary>
     /// The specified volume is read-only.
     /// </summary>
     VGFReadOnlyVolume = 0x80000,
     /// <summary>
     /// The volume supports a single sequential write.
     /// </summary>
     VGFSequentialWriteOnce = 0x100000,
     /// <summary>
     /// The volume supports transactions.
     /// </summary>
     VGFSupportsTransactions = 0x200000,
 }
...
public string VGFGetVolumeSerial(string DriveLetter)
{
...
public string VGFGetComputerDNSDomainName()
{
	bool success;
