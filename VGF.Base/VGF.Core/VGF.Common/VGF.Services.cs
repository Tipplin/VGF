        ...
        */
        ...
        public bool VGFTestStartUpAppConsole()
        {
            ...
            try
            {
                ...
                // string Path = @"C:\Users\Tippo\Software Creative Production\StartUpApp\StartUpApp\bin\Debug\StartUpApp.exe";

                // Set Filename and Path, see the unicode sign @, so only one Slash \ normal \\
                // URL, Server the same \\\..\\..\\ -> @ \\..\..\
                p.StartInfo.FileName = @"C:\Users\Tippo\Software Creative Production\StartUpApp\StartUpApp\bin\Debug\StartUpApp.exe";
                // No Window show!
