...
// Is not a Directive - Assembly, Is Only a namespace from a other Visual C# name.cs file
...
/*
 * NAMESPACE_BEGIN::Visual.Galaxy.Framework.Hardware
 * All Information of Hardware on current Computer and Network
 * 
 * 
 */
namespace Visual.Galaxy.Framework.Hardware
{
...
} // NAMESPACE_END::Visual.Galaxy.Framework.Hardware

//---------------------------------------------------------------------------//
//---------------------- END OF FILE::VGF.Hardware.cs -----------------------//
//---------------------------------------------------------------------------//