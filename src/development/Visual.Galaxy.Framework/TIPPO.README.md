...
----
##### General develop in Unicode - https://www.unicode.org - Handbook to Unicode Version 13.0.0 -
----
...
#### For own WinRT Components writing. Special: ModernCPP blog.
----
#### cppwinrt on Github - 
...
----
#### Microsoft  Programmiersprache  - X++  - 2017-06-20 -
----
...
----
#### Blazor community resources - Libraries, Samples
...
##### For Project SIMATIC BitBake .bb (P-sprache), Siemens Go - Programming Language with Source.
----
#### Mercedes Benz
##### https://github.com/topics/mercedes-benz
##### For Developers own Site:
...
##### Intel IoT Libraries & Code Samples from Intel
##### https://github.com/intel-iot-devkit
##### Intel® RealSense™ Open Source software from the Intel® RealSense™ team
###### https://github.com/IntelRealSense
##### Intel(R) Media Driver for VAAPI
###### https://github.com/intel/media-driver
##### OpenIntelWireless - Unofficial open source Intel Wireless projects for macOS
https://github.com/OpenIntelWireless

----
#### AMD
##### https://github.com/amd
##### Developer site SDKs and more:
...
----
#### LG
##### https://github.com/topics/lg
##### LG Silikon Valley LAB
...
##### https://philips-software.github.io/



----
#### Apache OpenOffice - Trunk
##### Searching for Developers:
##### https://github.com/apache/openoffice/tree/trunk/main
----
#### Apache OpenOffice - Apache Software Foundation - Brian Behlendorf - Apache Founder
##### https://openoffice.apache.org/source.html
----
#### Apache Software Foundation
----
#### Apache Software on GitHub
...
----
#### Computer-History-Site with Sourcecode for Products:
##### (Only for learning, NOT COMMERICAL !!!)
##### https://computerhistory.org/
----
##### MS-DOS - Operation System in Assembler NOW on GitHub
##### MS WORD -
##### Apple II (Lisa)
----
...
##### or
##### Wikipedia - List of Operation System
----
#### ROBOTRON
##### https://www.robotrontechnik.de/
##### Unix derivate (DDR):
##### GDR - Wega (Wega Website) - one Developer have all Handbooks to Operation System as Download .pdf on his Website.
#### Wega Community:
##### For years, found a complete Computersystem, hidden in Factory (GDR). All devices and more in orignal stand.
#### GDR - Mutos
##### Original Handbooks many to Operation Systems as download.
----
#### Robot Operation System:
##### http://www.ros.org/
----
#### ROS - Robot Operation System and more
##### https://github.com/Intermodalics
----
#### Windows Controls - Open Source for all
----
##### XAML UI Controls
