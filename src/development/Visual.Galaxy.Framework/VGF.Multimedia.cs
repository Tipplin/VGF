...
//
//-----------------------------------------------------------------------------
namespace Visual.Galaxy.Framework.Multimedia
{

    /// <summary>
    /// Class Multimedia
    /// </summary>
    public static class VGFMultimedia
    {
    ...
    } // end of class::VGFMultimedia

} // end of namespace::Visual.Galaxy.Framework.Multimedia
